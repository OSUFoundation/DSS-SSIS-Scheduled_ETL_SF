...
CREATE OR REPLACE TABLE "OSUF_INTERFACES"."FACULTY_STAFF"."SF_PhoneObject"
(
    ...
    ucinn_ascendv2__Extension nvarchar(10),
    ucinn_ascendv2__External_System_ID nvarchar(255),
    ucinn_ascendv2__Is_Preferred  NVARCHAR(18),
    ucinn_ascendv2__Notes STRING,
    ucinn_ascendv2__Phone_Name_Auto_Number nvarchar(30),
    ucinn_ascendv2__Phone_Number nvarchar(40),
