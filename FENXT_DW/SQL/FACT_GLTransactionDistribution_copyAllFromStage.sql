CREATE OR REPLACE TABLE "FENXT_DW"."BB"."FACT_GLTransactionDistribution" 
(
...
COPY INTO "FENXT_DW"."BB"."FACT_GLTransactionDistribution"   FROM '@BB_DELTA_STAGE/FACT_GLTransactionDistributionAll.csv.gz'
FORCE = TRUE
PURGE = TRUE
