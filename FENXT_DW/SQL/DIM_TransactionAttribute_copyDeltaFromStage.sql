CREATE OR REPLACE TABLE "FENXT_DW"."BB_DELTA"."DIM_TransactionAttribute" 
(
...
COPY INTO "FENXT_DW"."BB_DELTA"."DIM_TransactionAttribute"  FROM '@BB_DELTA_STAGE/DIM_TransactionAttributeDelta.csv.gz'
FORCE = TRUE
PURGE = TRUE
